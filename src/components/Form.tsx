...
export default function Form() {
  ...
  return (
    <>
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col mdOnly:flex-row w-full mdOnly::gap-5 xl:max-w-[608px]">
...
"
      ...
      <button type="submit" className="text-end flex justify-end duration-300 hover:opacity-40 focus:opacity-40 text-[30px] font-medium">
        SEND
      </button>
      </div>
    </form>
